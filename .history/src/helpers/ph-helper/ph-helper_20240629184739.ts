...
export class PhHelper {
  ...
  async getVideo(url: string): Promise<MediaDefinition> {
  ...
  function getMediaDefinition(mediaArray) {
    let defaultQualityMedia = null;
    let highestQualityMedia = null;
    let highestQualityUpTo720 = null;
    ...
    mediaArray.forEach(media => {
      ...
      if (media.quality <= 720 && (!highestQualityUpTo720 || media.quality > highestQualityUpTo720.quality)) {
