  ...
  reducers: {
    ...
    filterDataSource: (state, action: PayloadAction<ICreatorFilter>) => {
      ...
      if (action.payload.sortedBy) {
        ...
        filteredData.sort(
          (a: any, b: any) =>
            b.creator[action.payload.sortedBy] -
            a.creator[action.payload.sortedBy],
        );

        // filteredData.sort((a, b) => {
        //   const fieldA = (a.creator as any)[action.payload.sortedBy!];
        //   const fieldB = (b.category as any)[action.payload.sortedBy!];
